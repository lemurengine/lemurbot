...
<div class="form-group col-lg-6 col-md-6 col-sm-12 select2" data-test="category_group_id_div">
    ...
    {!! Form::select('category_group_slug', $categoryGroupList, (!empty($category)&(!empty($category->categoryGroup))?$category->categoryGroup->slug:$defaultCategoryGroup), [  LemurEngine\LemurBot\Models\WordSpelling::getFormValidation('category_group_id'), 'placeholder'=>'Please Select', 'class' => 'form-control allow-new select2', 'data-test'=>"$htmlTag-category_group_slug_select", 'id'=>"$htmlTag-category_group_slug_select-select"]) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="pattern_div">
    ...
    {!! Form::text('pattern', $machineLearntCategory->pattern, ['class' => 'form-control', LemurEngine\LemurBot\Models\Category::getFormValidation('pattern'),'id'=>"pattern_field", 'data-test'=>"pattern_field"] ) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="topic_div">
    ...
    {!! Form::text('topic', $machineLearntCategory->topic, ['class' => 'form-control', LemurEngine\LemurBot\Models\Category::getFormValidation('topic'),'id'=>"topic_field", 'data-test'=>"topic_field"] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="that_div">
    ...
    {!! Form::text('that', $machineLearntCategory->that, ['class' => 'form-control', LemurEngine\LemurBot\Models\Category::getFormValidation('that'),'id'=>"that_field", 'data-test'=>"that_field"] ) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="template_div">
    ...
    {!! Form::textarea('template', $machineLearntCategory->template, ['rows' => 10, 'class' => 'form-control', 'id'=>"template_field", 'data-test'=>"template_field", LemurEngine\LemurBot\Models\Category::getFormValidation('template')] ) !!}
...
<div class="clearfix"></div>
    ...
    <div class="form-group col-sm-6" data-test="delete_original_div">
        {!! Form::label('delete_original', 'Delete Machine Learnt Category:', ['data-test'=>"delete_original_label"]) !!}
        ...
        <span class="input-group-addon">
            ...
            <input type="text" class="form-control" aria-label="..." value="Delete the original machine learnt category on category creation?">
        </div><!-- /.col-lg-6 -->
    </div>

    <div class="clearfix"></div>

{!! Form::hidden('machine_learnt_category_id', $machineLearntCategory->slug) !!}
{!! Form::hidden('redirect_url', url('/machineLearntCategories')) !!}
