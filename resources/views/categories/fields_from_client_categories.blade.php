...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="pattern_div">
    ...
    {!! Form::text('pattern', $clientCategory->pattern, ['class' => 'form-control', LemurEngine\LemurBot\Models\Category::getFormValidation('pattern'),'id'=>"pattern_field", 'data-test'=>"pattern_field"] ) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="template_div">
    ...
    {!! Form::textarea('template', $clientCategory->template, ['rows' => 10, 'class' => 'form-control', 'id'=>"template_field", 'data-test'=>"template_field", LemurEngine\LemurBot\Models\Category::getFormValidation('template')] ) !!}
...
<div class="clearfix"></div>
    ...
    <div class="form-group col-sm-6" data-test="delete_original_div">
        {!! Form::label('delete_original', 'Delete Client Category:', ['data-test'=>"delete_original_label"]) !!}
        ...
        <span class="input-group-addon">
            ...
            <input type="text" class="form-control" aria-label="..." value="Delete the original client category on category creation?">
        </div><!-- /.col-lg-6 -->
    </div>

    <div class="clearfix"></div>

{!! Form::hidden('client_category_id', $clientCategory->slug) !!}
{!! Form::hidden('redirect_url', url('/clientCategories')) !!}
