                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <ul>
                                ...
                                <li>Any columns after the first two will be ignored</li>
                                <li>If the set name does not exist a new one will be created</li>
                        ...
                        <div class="col-md-12">
                            <h4>Select File:</h4>
                            {!! Form::open(['url' => 'setValuesUpload', 'data-test'=>$htmlTag.'-upload-form', 'class'=>'validate', 'name'=>$htmlTag.'-upload', 'enctype'=>"multipart/form-data"]) !!}
                            ...
                            <div class="form-group col-sm-12 col-lg-12">
                                ...
                                <div class="radio">
                                    <label>
                                        ...
                                        Append the new records to the set
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="processingOptions" id="processingOptions_b" value="delete">
                                        Delete all existing records from the set and create new
                                    </label>
                                </div>
                            </div>
