<div class="callout callout-info">
    <h4>Pop Up Chat Window</h4>
    <p>Follow the instructions below to add a avatar chat box onto your webpage. <a target="_new" href="https://lemurbot.com/avatar.html">Demo the avatar chat box</a></p>
</div>
    ...
    <ul class="timeline timeline-inverse">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-body clearfix">
                    ...
                    <div class="form-group" data-test="output_div">
                        ...
                        <textarea class="form-control" rows="3"><link rel="stylesheet" href="{!! env('APP_URL') !!}/widgets/popup/chat.css"></textarea>
                    </div>
                </div>
            </div>
        </li>
        ...
        <li>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-body clearfix">
                    <p>Place this in &lt;body>&lt;/body> wherever you want the popup chat window to be displayed</p>
                    <!-- HTML Field -->
                    <div class="form-group" data-test="output_div">
                        {!! Form::label('html', 'HTML:', ['data-test'=>"html"]) !!}
                        <textarea class="form-control" rows="3"><!-- bot chat window -->
<div id="chat-popup" data-botid="{!! $bot->slug !!}" data-clientid="" data-host="{!! env('APP_URL') !!}"></div>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-body clearfix">
                    ...
                    <div class="form-group" data-test="output_div">
                        ...
                        <textarea class="form-control" rows="3"><script type="text/javascript" src="{!! env('APP_URL') !!}/widgets/popup/chat.js"></script></textarea>
                    </div>
                </div>
            </div>
        </li>
