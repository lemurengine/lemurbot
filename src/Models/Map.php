...
class Map extends Model
{
    ...
    protected $cascadeDeletes = ['mapValues'];
     ...
     */
    public static $rules = [
        'name' => 'required|unique:maps,name|string|max:255',
    ...
    {
        return $this->hasMany(MapValue::class, 'map_id');
    }
    ...
    */
    public function dataTableQuery()
    {
            ...
            return Map::select([$this->table.'.*','users.email'])
