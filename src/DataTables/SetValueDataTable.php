...
class SetValueDataTable extends DataTable
{
     ...
     */
    public function query(SetValue $model)
    {
    ...
    {
        return [
            'set'=> ['name'=>'sets.name','data'=>'set','title'=>'setName', 'exportable'=>true],
            'value',
    ...
    {
        return 'set_values_datatable_' . time();
    }
}
