...
class BotAllowedSiteDataTable extends DataTable
{
     ...
     *
     * @param BotAllowedSite $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BotAllowedSite $model)
    {
    ...
    {
        return 'bot_allowed_sites_datatable_' . time();
    }
}
