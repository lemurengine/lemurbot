...
class ConversationPropertyDataTable extends DataTable
{
     ...
     *
     * @param ConversationProperty $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ConversationProperty $model)
    {
    ...
    {
        return 'conversation_properties_datatable_' . time();
    }
}
