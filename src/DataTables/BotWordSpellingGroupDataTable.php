...
class BotWordSpellingGroupDataTable extends DataTable
{
     ...
     *
     * @param BotWordSpellingGroup $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BotWordSpellingGroup $model)
    {
    ...
    protected function getColumns()
    {
        return [
            ...
            'word_spelling_group'=> ['title'=>'WordSpellingGroup'],
    ...
    {
        return 'bot_word_spelling_groups_datatable_' . time();
    }
}
