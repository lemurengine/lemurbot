...
class MapValueDataTable extends DataTable
{
     ...
     *
     * @param MapValue $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(MapValue $model)
    {
    ...
    {
        return [
            'map'=> ['name'=>'maps.name','data'=>'map','title'=>'mapName', 'exportable'=>true],
            'word',
            'value',
    ...
    {
        return 'map_values_datatable_' . time();
    }
}
