...
class ConversationSourceDataTable extends DataTable
{
     ...
     *
     * @param ConversationSource $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ConversationSource $model)
    {
    ...
    protected function getColumns()
    {
        return [
            ...
            'client'=> ['name'=>'clients.slug','data'=>'client','title'=>'ClientId','searchable'=>true,
