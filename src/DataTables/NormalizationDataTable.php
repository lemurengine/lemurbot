...
class NormalizationDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', function ($row) {
            ...
            return view(
                'lemurbot::layouts.datatables_actions',
     ...
     *
     * @param Normalization $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Normalization $model)
    {
    ...
    {
        return 'normalizations_datatable_' . time();
    }
}
